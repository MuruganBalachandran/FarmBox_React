                  ...
                  <tbody>
                      <tr className=" border-b ">
                          <td className="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                              <img className="img-cart rounded-full" src="../img/fruits/item-4.jpg" alt="" />
                          </td>
                      ...
                      <tr className=" border-b ">
                          <td className="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                              <img className="img-cart rounded-full" src="../img/vegetables/item-2.jpg" alt="" />
                          </td>
                          <td className="px-6 py-4">
                              Potatoes
                          </td>
                      ...
                      <tr className=" border-b ">
                          <td  className="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                              <img className="img-cart rounded-full" src="../img/vegetables/item-6.jpg" alt="" />
                          </td>
                          <td className="px-6 py-4">
                              Awesome Brocoli
                          </td>
