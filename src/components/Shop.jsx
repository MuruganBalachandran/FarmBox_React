...
import { fruits, vegetables } from '../data/Data';
    ...
    return (
        <div>
            <div className='sm:mx-20 lg:flex 2xl:mx-40'>
                <div className='mx-6'>
                    ...
                    <div>
                        <div className='bg-gray-100 w-full py-3 px-4 flex justify-between rounded-lg my-8'>
                            <label style={{color:'#45595b'}} htmlFor="filter">Default Sorting:</label>
                        ...
                        <ul className='flex flex-col'>
                            ...
                            <div className='flex justify-between leading-10'>
                                <li className='apple duration-500'><i className='fas fa-apple-alt'></i><span className='ml-2'>Strawberry</span></li>
                                <span>(2)</span>
                            </div>
                            <div className='flex justify-between leading-10'>
                        ...
                        <div className='my-8'>
                            ...
                            <div>
                                <Slider style={{color: '#39d285'}} defaultValue={0} aria-label="Default" min={0} max={500} valueLabelDisplay="auto" />
                            </div>
                        </div>
                ...
                <div className='w-full'>
                    ...
                    <div className='grid grid-cols-1 gap-2 mx-5 mt-10 md:grid-cols-2 xl:grid-cols-3 xl:gap-x-3 xl:gap-y-0'>
                        {fruits.map((val) => (
                            <div key={val.id} className='box border rounded-lg border-orange-300 pb-8 mx-auto mb-6 xl:mb-16 w-full'>
                    ...
                    <div className='grid grid-cols-1 gap-2 mx-5 mt-10 md:grid-cols-2 xl:grid-cols-3 xl:gap-x-3 xl:gap-y-0'>
                        {vegetables.map((val) => (
                            <div key={val.id} className='box border rounded-lg border-orange-300 pb-8 mx-auto mb-6 xl:mb-16 w-full'>
                                <div className='w-full relative overflow-clip'>
                                    <img className='hover:scale-150 duration-500 w-full rounded-lg' src={val.img} alt="" />
                                    <span className='absolute top-3 left-3 text-white text-lg py-1 px-4 rounded-xl' style={{backgroundColor: '#39d285'}}>Vegetables</span>
                                </div>
                                <div className='text-center'>
                                    <h3 className='text-2xl mt-5 font-semibold' style={{color: '#45595b'}}>{val.name}</h3>
                                    <p className='leading-normal font-normal my-4 w-10/12 mx-auto' style={{color: '#020e1ccf'}}>{val.desc}</p>
            ...
            <ul className='flex justify-center items-center mx-4 mt-20 next'>
                <li className='py-2 px-4 mx-1 border border-orange-300 rounded-lg' style={{color: '#45595b'}}>&#8656;</li>
                <li className='py-2 px-4 mx-1 border border-orange-300 rounded-lg' style={{color: '#fff', backgroundColor: '#39d285'}}>1</li>
                <li className='py-2 px-4 mx-1 border border-orange-300 rounded-lg' style={{color: '#45595b'}}>2</li>
                <li className='py-2 px-4 mx-1 border border-orange-300 rounded-lg' style={{color: '#45595b'}}>3</li>
                <li className='py-2 px-4 mx-1 border border-orange-300 rounded-lg' style={{color: '#45595b'}}>4</li>
                <li className='py-2 px-4 mx-1 border border-orange-300 rounded-lg' style={{color: '#45595b'}}>5</li>
                <li className='py-2 px-4 mx-1 border border-orange-300 rounded-lg' style={{color: '#45595b'}}>&#8658;</li>
            </ul>
        </div>
    )
