            ...
            {fact.map((val) => {
                return (
                    <div className='py-10 rounded-lg' style={{backgroundColor: '#fff'}} key={val.id}>
                        <span className='text-5xl' style={{color: '#eac499'}}>{val.icon}</span>
                        <h1 className='text-2xl w-52 sm:w-auto md:w-52 m-auto uppercase font-semibold my-6' style={{color: '#39d285'}}>{val.name}</h1>
