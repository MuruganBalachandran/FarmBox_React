...
const Footer = () => {
    return (
        <div className='mt-40 px-6 py-10 sm:px-20 md:px-24 lg:px-16 xl:px-20' style={{backgroundColor: '#49516f'}}>
            <div className='py-10 lg:grid lg:grid-cols-3 lg:items-center xl:flex xl:justify-between '>
                <div>
                    <h1 className='text-3xl font-semibold lg:text-4xl lg:grid-cols-1' style={{color: '#39d285'}}>FarmBox</h1>
                    <p className='text-md' style={{color: '#eac499'}}>Fresh products</p>
                </div>
                ...
                <ul className='flex justify-end'>
                    <li className='mx-1'><i className='fab fa-twitter py-3 px-3 social rounded-full border border-orange-300'></i></li>
                    <li className='mx-1'><i className='fab fa-facebook-f  py-3 px-4 social rounded-full border border-orange-300'></i></li>
                    <li className='mx-1'><i className='fab fa-youtube py-3 px-3 social rounded-full border border-orange-300'></i></li>
                    <li className='mx-1'><i className='fab fa-linkedin-in py-3 px-3 social rounded-full border border-orange-300'></i></li>
                </ul>
            </div>
            ...
            <div className='grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-y-8 lg:grid-cols-4'>
                ...
                <div>
                    ...
                    <div className='mt-5'>
                        <p className='footer-contact'>Address:Coimbatore,TamilNadu,India</p>
                        <p className='footer-contact'>Email: farmbox@gmail.com</p>
                        <p className='footer-contact'>Phone: +91 9999x 9xxxx</p>
            ...
            <div className='m-auto text-center'>
                <p className='font-medium' style={{color: '#ffffff80'}}><strong style={{color: '#dbb07e'}}>&copy; FarmBox, </strong>All Right Reserved .</p>
            </div>
        </div>
    )
}
