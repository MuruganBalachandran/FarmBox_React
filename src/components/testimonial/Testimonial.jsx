...
const Testimonial = () => {
    return (
        <div className='mt-40 mx-4 sm:mx-20'>
            <p className='text-center font-semibold text-xl lg:text-2xl' style={{color: '#39d285'}}>Our Testimonial</p>
                ...
                testimonial.map((val) => {
                    return (
                        <div key={val.id} className='rounded-lg' style={{backgroundColor: '#f4f6f8'}}>
                            ...
                            <hr className='w-10/12 m-auto h-0.5 xl:h-1 my-3' style={{backgroundColor: '#eac499'}}/>
                            <div className='flex justify-between my-6'>
                                <div className='flex mx-4'>
                                    ...
                                    <div className='flex flex-col justify-center ml-6'>
                                        ...
                                        <ul>
                                            <span style={{color: '#39d285'}}>{val.star}</span>
                                            <span style={{color: '#39d285'}}>{val.star}</span>
                                            <span style={{color: '#39d285'}}>{val.star}</span>
                                            <span style={{color: '#39d285'}}>{val.star}</span>
